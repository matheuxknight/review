...
function emailUnenrolled14Days($user)
{
$title = param('title');
$servername = getFullServerName();

mailex('', SANSSPACE_SMTP_EMAIL, $user->email, 'Need help enrolling in your Learning Site course?', 
	...
	<p>We noticed that you, '<b>$user->logon</b>', still haven’t enrolled in a course.</p>
	<p>How can we help? To enroll in a course, just click the “Enroll in my course” link in the upper right hand corner of the screen after logging in. We’ve created a helpful video to walk you through the process: <a href='http://www.waysidepublishing.com/learningsite'>waysidepublishing.com</a> .</p>
	<p>Don’t delay! If you still haven’t enrolled in another two weeks, your '<b>$user->logon</b>' account will be deleted during routine maintenance.  If you believe you are receiving this message in error, please contact us at your earliest convenience to avoid any potential disruption in your Learning Site access.</p>
<p>We’d be glad to help you enroll into a course. Email us at support@waysidepublishing.com, or give us a call in the office at (888) 302-2519. 
</p>
	<p>Sincerely,<br>
