...
function emailUnenrolled14DaysTeacher($user)
{
$title = param('title');
$servername = getFullServerName();

mailex('', SANSSPACE_SMTP_EMAIL, $user->email, 'Need help using the Learning Site?', 
	...
	<p>We noticed that you, '<b>$user->logon</b>', still haven’t created a course for your students in the Learning Site.</p>
	<p>Can we help? To create a course, just click the “Create my course” link in the upper right hand corner of the screen after logging in. We’ve created a helpful video to walk you through the process: <a href='http://www.waysidepublishing.com/learningsite'>waysidepublishing.com</a> .</p>
	<p>Don’t delay! If in two weeks you still haven’t created a course, your account will be automatically deleted during routine maintenance. If you believe you are receiving this message in error, please contact us at your earliest convenience to avoid any potential disruption in your Learning Site access.</p>
<p>We’d be glad to help you create a course, and get your students enrolled. Email us at support@waysidepublishing.com, or give us a call in the office at (888) 302-2519. 
</p>
	<p>Sincerely,<br>
