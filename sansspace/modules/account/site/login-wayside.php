	...
	$(document).ready(function() 
{
	...
	$('#popuplink').click(function(){ $('div#popup').dialog('open'); $('#register_frame').attr('src', '/file/embed?id=18087');});
})
</script>
<div id="popup" title="Registering for an account">
    ...
    <p style='font-size:14px; text-align:center'><iframe id='register_frame' width=480 height=360 frameborder=0 seamless src=''></iframe></p>
</div>
end;
