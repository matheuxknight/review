			...
			<div id='trainingcontentinner'>
				<div id='topiclistdiv'>
					<ul id='startedlist' class='topiclist'>
						...
						<li id='generallink1' class='listItem topiclistactive' description='The Signing Up for an Account video offers an in-depth look on how to create a Learning Site account as both a student and then as a teacher. The video covers this process by using the Account Registration form.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=18087' onclick='setListItem(this)' name='first'>
						Signing Up for an Account</li>
						
						<li id='generallink2' class='listItem topiclistblur' description='The Creating My Course video offers an in-depth look at how a teacher is able to create their own course on the Learning Site.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=18088' onclick='setListItem(this)'>
						Creating My Course</li>
						
						<li id='generallink3' class='listItem topiclistblur' description='The Enrolling in My Course video offers an in-depth look on how students are able to enroll within their teacher's course once it has been created by their instructor, first.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=18089' onclick='setListItem(this)'>
						Enrolling in My Course</li>
						
						<li id='generallink4' class='listItem topiclistblur' description='The Navigating the Learning Site video takes a look at the main My Learning Site page upon login and how to navigate and utilize the various options from within.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=42905' onclick='setListItem(this)'>
						Navigating the Learning Site</li>
					</ul>
					<ul id='navigatelist' class='topiclist hiddenlist'>
					
						<li id='navigatelink1' class='listItem topiclistactive' description='The Learning Site Basics Webinar conducted on January 7, 2015, offers instructions on how to navigate the My Learning Site tab and all items associated with it such as the Courses, Grades, My Files, Inbox, and Settings tiles.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=50634' onclick='setListItem(this)' name='first' >Learning Site Basics</li>
						
						<li id='navigatelink2' class='listItem topiclistblur' description='The Assessing Student Performance and Grades webinar conducted on January 14, 2015, offers an in-depth look at how to assess survey and discussion forum participation, as well as how to grade all quiz types.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=50633' onclick='setListItem(this)'>Student Performance and Grades</li>
						
						<!--<li id='navigatelink3' class='listItem topiclistblur' description='The Classroom Forum webinar provides insight as to what is and who your class might be able to use the Classroom Forum. This area can be used for group discussions, providing external context, assigning work, etc.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=43368' onclick='setListItem(this)'>
						Classroom Forum</li>-->
						
						<li id='navigatelink4' class='listItem topiclistblur' description='The Learning Site Activities webinar conducted on January 28, 2015 offers an in-depth look at how students and teachers can navigate through all quiz types, flashcards, surveys, discussion forums, and PDF forms.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=52473' onclick='setListItem(this)'>Learning Site Activities</li>
						
						<li id='navigatelink5' class='listItem topiclistblur' description='The Using the Comparative Recorder webinar conducted on January 21, 2015, offers a detailed look at the technological requirements for the comparative recorder, how a student records and reviews teacher feedback, and how a teacher can provide precision feedback to any student recorded audio.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=51922' onclick='setListItem(this)'>Using the Comparative Recorder</li>
	
					</ul>
					<ul id='programlist' class='topiclist hiddenlist'>
					
						<li id='triangulolink1' class='listItem topiclistactive' description='The Tr&aacute;ngulo Aprobado webinar conducted on September 29, 2014, offers an in-depth look at the Tri&aacute;ngulo Aprobado Student Edition, Teacher Edition, Learning Site materials and navigation, and the integration of all three components of the program.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=47716' onclick='setListItem(this)' name='first'>
						Tri&aacute;ngulo Webinar</li>
						
						<li id='tejidoslink1' class='listItem topiclistblur' description='The Tejidos webinar conducted on September 29, 2014, offers an in-depth look at the Tejidos Student Edition, Teacher Edition, Learning Site materials and navigation, and the integration of all three components of the program.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=47727' onclick='setListItem(this)'>
						Tejidos Webinar</li>
						
						<li id='azulejolink1' class='listItem topiclistblur' description='The Azuljo webinar conducted on September 29, 2014, offers an in-depth look at the Azulejo Student Edition, Teacher Edition, Learning Site materials and navigation, and the integration of all three components of the program.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=47750' onclick='setListItem(this)'>
						Azulejo Webinar</li>
						
						<li id='neuelink1' class='listItem topiclistblur' description='The Neue Blickwinkel webinar conducted on September 29, 2014, offers an in-depth look at the Neue Blickwinkel Student Edition, Teacher Edition, Learning Site materials and navigation, and the integration of all three components of the program.' data='http://reviewlearningsite.waysidepublishing.com/file/embed?id=47755' onclick='setListItem(this)'>
				...
				<div id='trainingvideo'>
					<iframe id='webinariframe' width=480 height=360 frameborder=0 seamless src='http://reviewlearningsite.waysidepublishing.com/file/embed?id=18087'></iframe>
				</div>
